<div class="br-sideleft overflow-y-auto">
        ...
        <ul class="br-sideleft-menu">
          ...
          <li class="br-menu-item">
            <a href="/admin/home" class="br-menu-link ">
              <i class="menu-item-icon icon ion-images tx-24"></i>
              <span class="menu-item-label">Slid</span>
            </a><!-- br-menu-link -->
          </li><!-- br-menu-item -->
          <li class="br-menu-item">
            <a href="/admin/services" class="br-menu-link">
              <i class="menu-item-icon icon ion-settings tx-24"></i>
              <span class="menu-item-label">Services</span>
            </a><!-- br-menu-link -->
          </li><!-- br-menu-item -->
          <li class="br-menu-item">
            <a href="/admin/sociallinks" class="br-menu-link">
              <i class="menu-item-icon icon ion-link tx-24"></i>
              <span class="menu-item-label">Social Links</span>
            </a><!-- br-menu-link -->
          </li><!-- br-menu-item -->
          <li class="br-menu-item">
            <a href="/admin/subscribers" class="br-menu-link">
